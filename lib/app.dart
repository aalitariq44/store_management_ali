  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        // ChangeNotifierProvider(create: (context) => InternetProvider()), // مخفي مؤقتاً
        ChangeNotifierProvider(create: (context) => BackupProvider()),
        ChangeNotifierProvider(create: (context) => IncomeProvider()),
      ],
      child: Consumer3<PersonProvider, DebtProvider, InstallmentProvider>(
        // تم تغيير من Consumer4 إلى Consumer3
        builder:
            (
              context,
              personProvider,
              ...
              // Set up cross-provider references
              personProvider.setOtherProviders(
